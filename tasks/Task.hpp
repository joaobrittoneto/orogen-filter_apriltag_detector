...
#ifndef FILTER_APRILTAG_DETECTOR_TASK_TASK_HPP
...
tasks/Task.cpp, and will be put in the filter_apriltag_detector namespace.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','filter_apriltag_detector::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "filter_apriltag_detector::Task");
